import { IProduk } from "@/pages/masterdata/produk/produk.type";
...
const FormPesanan: React.FC<ProdukListProps> = (props) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex justify-center items-center">
      ...
      >
        <div className="text-xl font-bold mb-3">Form Pesanan</div>
        ...
        {/* Jumlah */}
        <div className="flex flex-col mb-2">
          <span className="font-semibold text-md">Jumlah</span>
        ...
        {/* Luas Paving */}
        <div className="flex flex-col mb-2">
          <span className="font-semibold">Luas Paving(m2)</span>
          <input
            type="text"
            value={luasPaving}
