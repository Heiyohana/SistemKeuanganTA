      ...
      <table className="text-left border-2 border-blue-500">
        <thead className="bg-blue-500 items-center text-white">
          <tr className={`${styles.thtable}`}>
            ...
            <th className="px-4 py-1 text-center">Role</th>
            <th className="px-4 py-1 text-center">Sandi</th>
          ...
          {itemsToShow.map((user, index) => {
            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-1 text-center">{user.role}</td>
                <td className="px-4 py-1">{user.sandi}</td>
